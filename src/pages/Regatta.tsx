...
import { Sailboat, HeartHandshake, Trophy, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            ...
            grown into the island&rsquo;s most anticipated charity event. Each year, sailors, sponsors and
